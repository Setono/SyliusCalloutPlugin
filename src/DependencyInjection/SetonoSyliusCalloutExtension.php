...
final class SetonoSyliusCalloutExtension extends AbstractResourceExtension implements PrependExtensionInterface
{
    public function load(array $config, ContainerBuilder $container): void
    {
        ...
        $container->setParameter('setono_sylius_callout.messenger.command_bus', $config['messenger']['command_bus']);
        $container->setParameter('setono_sylius_callout.messenger.transport', $config['messenger']['transport']);
